...
export const MENU_ITEMS = [
  ...
  { id: 'bb-thai-tea', name: 'Bear Brand Thai Tea', name_th: 'นมหมีชาไทย', price: 50, category: 'bear_brand', available: true, sweetness_options: true, toppings: [], image: IMAGES.bear_brand },
  { id: 'bb-green-tea', name: 'Bear Brand Green Tea', name_th: 'นมหมีชาเขียว', price: 50, category: 'bear_brand', available: true, sweetness_options: true, toppings: [], image: IMAGES.bear_brand },
  { id: 'bb-taro', name: 'Bear Brand Taro', name_th: 'นมหมีเผือกหอม', price: 50, category: 'bear_brand', available: true, sweetness_options: true, toppings: [], image: IMAGES.bear_brand },
  { id: 'bb-pink', name: 'Bear Brand Pink Milk', name_th: 'นมหมีชมพู', price: 50, category: 'bear_brand', available: true, sweetness_options: true, toppings: [], image: IMAGES.bear_brand },
  { id: 'bb-caramel', name: 'Bear Brand Caramel', name_th: 'นมหมีคาราเมล', price: 50, category: 'bear_brand', available: true, sweetness_options: true, toppings: [], image: IMAGES.bear_brand },
  { id: 'bb-cocoa', name: 'Bear Brand Cocoa', name_th: 'นมหมีโกโก้', price: 50, category: 'bear_brand', available: true, sweetness_options: true, toppings: [], image: IMAGES.bear_brand },
  { id: 'bb-strawberry', name: 'Bear Brand Strawberry', name_th: 'นมหมีสตรอเบอร์รี่', price: 50, category: 'bear_brand', available: true, sweetness_options: true, toppings: [], image: IMAGES.bear_brand },
  { id: 'bb-oreo', name: 'Bear Brand Oreo', name_th: 'นมหมีโอริโอ้', price: 50, category: 'bear_brand', available: true, sweetness_options: true, toppings: [], image: IMAGES.bear_brand },
  ...
  // Smoothie & Yogurt
  { id: 'sy-orange', name: 'Orange', name_th: 'ส้ม', price: 40, category: 'smoothie_yogurt', available: true, sweetness_options: true, toppings: ['ทำโยเกิร์ตปั่น +5'], image: IMAGES.smoothie_yogurt },
  { id: 'sy-mango', name: 'Mango', name_th: 'มะม่วง', price: 40, category: 'smoothie_yogurt', available: true, sweetness_options: true, toppings: ['ทำโยเกิร์ตปั่น +5'], image: IMAGES.smoothie_yogurt },
  { id: 'sy-pineapple', name: 'Pineapple', name_th: 'สับปะรด', price: 40, category: 'smoothie_yogurt', available: true, sweetness_options: true, toppings: ['ทำโยเกิร์ตปั่น +5'], image: IMAGES.smoothie_yogurt },
  { id: 'sy-kiwi', name: 'Kiwi', name_th: 'กีวี่', price: 40, category: 'smoothie_yogurt', available: true, sweetness_options: true, toppings: ['ทำโยเกิร์ตปั่น +5'], image: IMAGES.smoothie_yogurt },
  { id: 'sy-passion', name: 'Passion Fruit', name_th: 'เสาวรส', price: 40, category: 'smoothie_yogurt', available: true, sweetness_options: true, toppings: ['ทำโยเกิร์ตปั่น +5'], image: IMAGES.smoothie_yogurt },
  { id: 'sy-watermelon', name: 'Watermelon', name_th: 'แตงโม', price: 40, category: 'smoothie_yogurt', available: true, sweetness_options: true, toppings: ['ทำโยเกิร์ตปั่น +5'], image: IMAGES.smoothie_yogurt },
  { id: 'sy-lemon', name: 'Lemon', name_th: 'มะนาว', price: 40, category: 'smoothie_yogurt', available: true, sweetness_options: true, toppings: ['ทำโยเกิร์ตปั่น +5'], image: IMAGES.smoothie_yogurt },
  { id: 'sy-strawberry', name: 'Strawberry', name_th: 'สตรอเบอร์รี่', price: 40, category: 'smoothie_yogurt', available: true, sweetness_options: true, toppings: ['ทำโยเกิร์ตปั่น +5'], image: IMAGES.smoothie_yogurt },
  { id: 'sy-blueberry', name: 'Blueberry', name_th: 'บลูเบอร์รี่', price: 60, category: 'smoothie_yogurt', available: true, sweetness_options: true, toppings: ['ทำโยเกิร์ตปั่น +5'], image: IMAGES.smoothie_yogurt },
  { id: 'sy-mixberry', name: 'Mix Berry', name_th: 'มิกซ์เบอร์รี่', price: 60, category: 'smoothie_yogurt', available: true, sweetness_options: true, toppings: ['ทำโยเกิร์ตปั่น +5'], image: IMAGES.smoothie_yogurt },

  // Avocado
  { id: 'av-honey', name: 'Avocado Honey', name_th: 'อะโวคาโดน้ำผึ้ง', price: 55, category: 'avocado', available: true, sweetness_options: true, toppings: [], image: IMAGES.avocado },
  { id: 'av-yogurt', name: 'Avocado Yogurt', name_th: 'อะโวคาโดโยเกิร์ต', price: 55, category: 'avocado', available: true, sweetness_options: true, toppings: [], image: IMAGES.avocado },
  { id: 'av-milk', name: 'Avocado Milk', name_th: 'อะโวคาโดนมสด', price: 55, category: 'avocado', available: true, sweetness_options: true, toppings: [], image: IMAGES.avocado },
  { id: 'av-caramel', name: 'Avocado Caramel', name_th: 'อะโวคาโดคาราเมล', price: 55, category: 'avocado', available: true, sweetness_options: true, toppings: [], image: IMAGES.avocado },
  { id: 'av-milo', name: 'Avocado Milo', name_th: 'อะโวคาโดไมโล', price: 55, category: 'avocado', available: true, sweetness_options: true, toppings: [], image: IMAGES.avocado },
  { id: 'av-nesvita', name: 'Avocado Nesvita', name_th: 'อะโวคาโดเนสวีต้า', price: 55, category: 'avocado', available: true, sweetness_options: true, toppings: [], image: IMAGES.avocado },
  { id: 'av-coconut', name: 'Avocado Coconut', name_th: 'อะโวคาโดมะพร้าว', price: 60, category: 'avocado', available: true, sweetness_options: true, toppings: [], image: IMAGES.avocado },
  { id: 'av-cocoa', name: 'Avocado Cocoa', name_th: 'อะโวคาโดโกโก้', price: 60, category: 'avocado', available: true, sweetness_options: true, toppings: [], image: IMAGES.avocado },
  { id: 'av-banana', name: 'Avocado Banana', name_th: 'อะโวคาโดกล้วย', price: 60, category: 'avocado', available: true, sweetness_options: true, toppings: [], image: IMAGES.avocado },
  { id: 'av-passion', name: 'Avocado Passion Fruit', name_th: 'อะโวคาโดเสาวรส', price: 60, category: 'avocado', available: true, sweetness_options: true, toppings: [], image: IMAGES.avocado },
  { id: 'av-almond', name: 'Avocado Almond', name_th: 'อะโวคาโดนมอัลมอนด์', price: 65, category: 'avocado', available: true, sweetness_options: true, toppings: [], image: IMAGES.avocado },

  // Oreo
  { id: 'or-milk', name: 'Oreo Milk', name_th: 'นมสดโอริโอ้', price: 45, category: 'oreo', available: true, sweetness_options: true, toppings: [], image: IMAGES.oreo },
  { id: 'or-thai-tea', name: 'Oreo Thai Tea', name_th: 'ชาไทยโอริโอ้', price: 50, category: 'oreo', available: true, sweetness_options: true, toppings: [], image: IMAGES.oreo },
  { id: 'or-green-tea', name: 'Oreo Green Tea', name_th: 'ชาเขียวโอริโอ้', price: 50, category: 'oreo', available: true, sweetness_options: true, toppings: [], image: IMAGES.oreo },
  { id: 'or-cocoa', name: 'Oreo Cocoa', name_th: 'โกโก้โอริโอ้', price: 50, category: 'oreo', available: true, sweetness_options: true, toppings: [], image: IMAGES.oreo },
  { id: 'or-pink', name: 'Oreo Pink Milk', name_th: 'นมชมพูโอริโอ้', price: 50, category: 'oreo', available: true, sweetness_options: true, toppings: [], image: IMAGES.oreo },
  { id: 'or-ovaltine', name: 'Oreo Ovaltine', name_th: 'โอวัลตินโอริโอ้', price: 50, category: 'oreo', available: true, sweetness_options: true, toppings: [], image: IMAGES.oreo },
  { id: 'or-taro', name: 'Oreo Taro', name_th: 'เผือกโอริโอ้', price: 50, category: 'oreo', available: true, sweetness_options: true, toppings: [], image: IMAGES.oreo },
  { id: 'or-coffee', name: 'Oreo Coffee', name_th: 'กาแฟโอริโอ้', price: 55, category: 'oreo', available: true, sweetness_options: true, toppings: [], image: IMAGES.oreo },
