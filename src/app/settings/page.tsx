  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--surface)' }}>
      ...
      <div style={{
        ...
        <div className="header-content" style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              ...
              <p style={{ color: 'rgba(245,230,211,0.7)', fontSize: '13px' }}>{t.desc}</p>
            </div>
          </div>
